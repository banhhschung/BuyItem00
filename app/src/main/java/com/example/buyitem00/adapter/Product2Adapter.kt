...
import com.example.buyitem00.databinding.Product2LayoutBinding
import com.example.buyitem00.model.Product
import java.util.ArrayList

class Product2Adapter(private val callback: OnclickItemListener) :
    RecyclerView.Adapter<Product2Adapter.ViewHolder>() {
    ...
    class ViewHolder(val binding: Product2LayoutBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = Product2LayoutBinding.inflate(LayoutInflater.from(parent.context))
