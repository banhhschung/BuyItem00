...
import com.example.buyitem00.databinding.Product3LayoutBinding
import com.example.buyitem00.model.Product
import java.util.ArrayList

class Product3Adapter(private val callback: OnclickItemListener) :
    RecyclerView.Adapter<Product3Adapter.ViewHolder>() {
    ...
    class ViewHolder(val binding: Product3LayoutBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val binding = Product3LayoutBinding.inflate(LayoutInflater.from(parent.context))
